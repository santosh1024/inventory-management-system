...
export default function InsertProduct() {
    ...
    useEffect(() => {
        const getProduct = async () => {
          try {
            const res = await fetch(`https://inventory-management-system-enid.onrender.com/products/${id}`, {
              method: "GET",
              headers: {
    ...
    const updateProduct = async (e) => {
        ...
        try {
            const response = await fetch(`https://inventory-management-system-enid.onrender.com/updateproduct/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
